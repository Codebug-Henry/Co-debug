...
- **REQUERIMIENTOS**: por query deberan enviar page, limit, sort para definir como ordenarlos (puntos/preguntas/respuestas y asc/desc), admin si solo se quieren obtener los usuarios que son o no son admin, all si se quieren todos los usuarios incluidos los baneados/eliminados, y search si se quiere buscar por email

        /?sort=points-asc/points-desc/quest-asc/quest-desc/answ-asc/answ-desc
