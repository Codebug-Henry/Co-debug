...
const populateDB = async () => {
    ...
    const users = [
        ...
        { sub: '5',  name: 'Luciano',  nickname: 'lucho', email: 'lucho@gmail.com', locale: 'argentina', favourites: [2, 3], cantFav: 2, cantAns: 2 },
        { sub: '6',  name: 'Gustavo',  nickname: 'gus', email: 'gus@gmail.com', locale: 'argentina', cantAns: 2 },
        { sub: '7',  name: 'Patricio',  nickname: 'pato', email: 'pato@gmail.com', locale: 'argentina', cantAns: 2 },
        { sub: '8',  name: 'Matias',  nickname: 'mati', email: 'mati@gmail.com', locale: 'argentina', cantAns: 1 },
    ]
