...
const populateDB = async () => {
    ...
    const users = [
        ...
        { sub: '2',  name: 'Santiago',  nickname: 'Santi', email: 'santi@gmail.com', locale: 'Argentina', myTeachPoints: 200, favourites: [3, 4, 5], cantFav: 3, cantQuest: 2, cantAns: 1, picture: "https://res.cloudinary.com/codebugers/image/upload/v1656613573/codebug/cishty3ie3xxldbgpryt.jpg" },
        { sub: '3',  name: 'Felipe',  nickname: 'Feli', email: 'feli@gmail.com', locale: 'Argentina', myTeachPoints: 300, favourites: [1], cantFav: 1, cantQuest: 1, cantAns: 2, picture: "https://res.cloudinary.com/codebugers/image/upload/v1656642327/codebug/ls3q6jh4b7nnkstdjvnc.jpg" },
        { sub: '4',  name: 'David',  nickname: 'Davo', email: 'davo@gmail.com', locale: 'Argentina', myTeachPoints: 400, cantAns: 2, picture: "https://res.cloudinary.com/codebugers/image/upload/v1656635530/codebug/sxaohmgkzc1wvx8u37qj.jpg" },
        ...
        { sub: '7',  name: 'Patricio',  nickname: 'Pato', email: 'pato@gmail.com', locale: 'Argentina', myTeachPoints: 700, cantAns: 2, picture: "https://media-exp1.licdn.com/dms/image/D4D35AQFZmGrAaKPK8A/profile-framedphoto-shrink_800_800/0/1655595844858?e=1657310400&v=beta&t=-2Uoxv1mu7U5m4oeB89MHKLQW5chhEWWLqozMFvVD0A" },
        { sub: '8',  name: 'Matias',  nickname: 'Mati', email: 'mati@gmail.com', locale: 'Argentina', myTeachPoints: 800, cantAns: 1, picture: "https://res.cloudinary.com/codebugers/image/upload/v1656605851/codebug/gpiz9uxtds9dtihu69cx.png" },
