...
const postAnswer = async (req, res, next) => {
   ...
   try {
      ...
      if (sub !== userReceiver.sub) {
         let textNotif = `¡${user.nickname} respondió tu pregunta!`
...
const putAnswer = async (req, res, next) => {
   ...
   try {
      ...
      if (statusValidated) {
         ...
         // Notifications
         let textNotif = `¡${userLogged.nickname} validó tu respuesta! ¡Sumas ${answer.teachPoints} Teach Points a tu cuenta personal!`
