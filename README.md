...
Among the functions to be developed, we can highlight the evaluation of answers to questions with more time without solving. We rate those who help and highlight them in a ranking according to their participation. We also make interactions public so users can learn from others' questions.
...
It is worth noting that the project is designed to be used by people who are currently studying this career.
