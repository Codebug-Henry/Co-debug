...
export const getAllQuestions = (sort, page, validated) =>
  axios.get(
    `/questions?sort=${sort}&page=${page}&validated=${validated}&limit=5`
  );
export const getSearchQuestions = (search, sort, page, validated) =>
  axios.get(
    `/questions?search=${search}&sort=${sort}&page=${page}&validated=${validated}&limit=5`
  );
...
export const putNotification = (notification) =>
  axios.put(`/message`, notification);
