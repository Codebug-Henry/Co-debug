...
export default function Paginated({page, setPage, totalPages}) {
    ...
    return(
        <div className={style.bar}>
            <ul> 
                <button className={page === 1 || pages.length === 0 ? style.notDisplay : style.prev} onClick={e=>handlePrev(e)} > Anterior </button>
                <button className={page > 3 ? style.one : style.notDisplay} onClick={e=>setPage(1)}> 1 </button>
                <button className={page > 4 ? style.firstDot : style.notDisplay}> ... </button>
